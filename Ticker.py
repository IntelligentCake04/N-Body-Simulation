...
class Ticker:
    ...
    def string_stats(self):
        ...
        """        
        return ["avg_load: {}".format(self.avg_load),
                'max_load: {}.'.format(self.max_load),
                'min_load: {}'.format(self.min_load),
                'run_time: {}'.format(self.run_time),
                'iter_len: {}'.format(self.iter_len)]
