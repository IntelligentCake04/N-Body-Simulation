...
TODO:
    ...
    - Saving simulation state with button - JSON
    - Reading simulation states - JSON
    - Create a simulation that is a proper solar system
    - Visual effect for merging bodies
    - Selection buttons for showing force and velocity for each particle
    - Call window size as a parameter or resize once running
"""
...
class Window:
    ...
    def main_loop(self, simulation):
        ...
        while running:
            ...
            bodies_text = "nr_bodies : {}".format(len(simulation.bodies))
    ...
    def mouse_draw(self, simulation):
        """
        Lets the user draw a line with their right mouse button. The line info
